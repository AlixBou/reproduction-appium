...
export const useBeforeMountEffect = (
  ...
  const callbackCleanup = useRef<() => void>()
  ...
  useEffect(() => {
    return () => callbackCleanup.current?.()
  }, [])
}
